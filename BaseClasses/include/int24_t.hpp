...
using int24_t = struct _int24_t
{
	...
	constexpr _int24_t(int8_t integer)
		: data(integer)
	{ }
	constexpr _int24_t(uint8_t integer)
		: data(integer)
	{ }
	constexpr _int24_t(int16_t integer)
		: data(integer)
	{ }
	constexpr _int24_t(uint16_t integer)
		: data(integer)
	{ }
	explicit _int24_t(int32_t integer)
		: data(static_cast<_int24_t>(integer))
	{ }
